...
int menu = 1, option = 1, time_value = 0, temp_value = 0, dial_value = 0, time_min = 1, temp = 1, timeOVF = 0;
...
void menu_options(int menu_type, int region, String heading, int time_min, float temp) { // FIXME: Chuck - I changed the temperature input to float -- untested
...
void menu_1(int option) { // Curing Settings Menu
  switch (option) {
    case 1: (1, 1, " ", 0, 0);
            ...
            menu_options(1, 2, "Clear", clrResin[1], clrResin[0]);
            menu_options(1, 3, "Opaque", 0, 0);
            break;
    case 2: menu_options(1, 1, "Clear", 0, 0);
            menu_options(1, 2, "Opaque", colorResin[1], colorResin[0]);
            menu_options(1, 3, "Grey Pro", 0, 0);
            break;
    case 3: menu_options(1, 1, "Opaque", 0, 0);
            menu_options(1, 2, "Grey Pro", gpResin[1], gpResin[0]);
            menu_options(1, 3, "Rigid", 0, 0);
            break;
    case 4: menu_options(1, 1, "Grey Pro", 0, 0);
            menu_options(1, 2, "Rigid", rigidResin[1], rigidResin[0]);
            menu_options(1, 3, "Tough", 0, 0);
            break;
    case 5: menu_options(1, 1, "Rigid", 0, 0);
            menu_options(1, 2, "Tough", toughResin[1], toughResin[0]);
            menu_options(1, 3, "Durable", 0, 0);
            break;
    case 6: menu_options(1, 1, "Tough", 0, 0);
            menu_options(1, 2, "Durable", durResin[1], durResin[0]);
            menu_options(1, 3, "High T", 0, 0);
            break;
    case 7: menu_options(1, 1, "Durable", 0, 0);
            menu_options(1, 2, "High T", highResin[1], highResin[0]);
            menu_options(1, 3, "Castable", 0, 0);
            break;
    case 8: menu_options(1, 1, "High T", 0, 0);
            menu_options(1, 2, "Castable", castResin[1], castResin[0]);
            menu_options(1, 3, "Preset 1", 0, 0);
            break;
    case 9: menu_options(1, 1, "Castable", 0, 0);
            menu_options(1, 2, "Preset 1", preset1Resin[1], preset1Resin[0]);
            menu_options(1, 3, "Preset 2", 0, 0);
            break;
    case 10:menu_options(1, 1, "Preset 1", 0, 0);
            menu_options(1, 2, "Preset 2", preset2Resin[1], preset2Resin[0]);
            menu_options(1, 3, "Preset 3", 0, 0);
            break;
    case 11:menu_options(1, 1, "Preset 2", 0, 0);
            menu_options(1, 2, "Preset 3", preset3Resin[1], preset3Resin[0]);
            menu_options(1, 3, "Preset 4", 0, 0);
            break;
    case 12:menu_options(1, 1, "Preset 3", 0, 0);
            menu_options(1, 2, "Preset 4", preset4Resin[1], preset4Resin[0]);
            menu_options(1, 3, "Preset 5", 0, 0);
            break;
    case 13:menu_options(1, 1, "Preset 4", 0, 0);
            menu_options(1, 2, "Preset 5", preset5Resin[1], preset5Resin[0]);
            menu_options(1, 3, "Custom Set", 0, 0);
            break;
    default:menu_options(1, 1, "Preset 5", 0, 0);
            menu_options(4, 2, "Custom Set", 95, 95);
...
void menu_4(int option) { // Curing Settings Menu
  switch (option) {
    ...
    case 6: menu_options(1, 1, "Preset 5", 0, 0);
            menu_options(4, 2, "Dont Save", 0, 0);
            menu_options(4, 3, "Return", 0, 0);
            break;
    default:menu_options(4, 1, "Dont Save", 0, 0);
...
void menu_5(int option) { // Confirm Settings Menu
  ...
  switch (option) {
    case 1: menu_options(4, 1, " ", 0, 0);
            menu_options(4, 2, "Start Job", 0, 0);
            menu_options(4, 3, "Return", 0, 0);
            break;
    default:menu_options(4, 1, "Start Job", 0, 0);
            menu_options(4, 2, "Return", 0, 0);
...
void curing_screen(int current_time, float current_temp) { // Pause Menu Settings
  int newTime = cureProgress / 60000;
  menu_options(5, 1, "Press Button to Pause", 0, 0);
  menu_options(5, 2, "Current", newTime, roundf(currentTemp*10)/10);
  if(cureComplete == 1) {
    menu_options(5, 3, "Cure Done, Move Dial", 0 , 0);
    cureComplete = 0;
  }
  else
    menu_options(5, 3, " ", 0, 0);
}
...
bool update_menu_options(int dial_value, bool button_value) {
  // Menu 1 = Resin Types
  if(menu == 1) {
    if((option >= 1 && option < 14 && dial_value == 1) || (option > 1 && option <= 14 && dial_value == -1))
      option += dial_value;
    if(button_value) {
      switch(option){
      case 1: cureTemp = clrResin[0];
              cureTime = clrResin[1];
              menu = 5;
              break;
      case 2: cureTemp = colorResin[0];
              cureTime = colorResin[1];
              menu = 5;
              break;
      case 3: cureTemp = gpResin[0];
              cureTime = gpResin[1];
              menu = 5;
              break;
      case 4: cureTemp = rigidResin[0];
              cureTime = rigidResin[1];
              menu = 5;
              break;
      case 5: cureTemp = toughResin[0];
              cureTime = toughResin[1];
              menu = 5;
              break;
      case 6: cureTemp = durResin[0];
              cureTime = durResin[1];
              menu = 5;
              break;
      case 7: cureTemp = highResin[0];
              cureTime = highResin[1];
              menu = 5;
              break;
      case 8: cureTemp = castResin[0];
              cureTime = castResin[1];
              menu = 5;
              break;
      case 9: cureTemp = preset1Resin[0];
              cureTime = preset1Resin[1];
              menu = 5;
              break;
      case 10:cureTemp = preset2Resin[0];
              cureTime = preset2Resin[1];
              menu = 5;
              break;
      case 11:cureTemp = preset3Resin[0];
              cureTime = preset3Resin[1];
              menu = 5;
              break;
      case 12:cureTemp = preset4Resin[0];
              cureTime = preset4Resin[1];
              menu = 5;
              break;
      case 13:cureTemp = preset5Resin[0];
...
void update_display() {
  // Poll the pushbutton and rotary encoder
  dial_value = poll_rotary_dial();
  button_value = poll_button();
  // Display menu changes when button or encoder see changes
  if((dial_value != 0) || button_value)
    if(update_menu_options(dial_value, button_value))
      display_menu(menu, option, 0);

  // Update Menu periodically when curing is in progress
  if(!pauseState && cureState && (cureProgress % 1000 == 0) && cureProgress > 0) {
    display_menu(menu, option, 0);
    Serial.println("Update Curing Screen");
  }
}
