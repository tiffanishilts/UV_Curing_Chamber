  ...
  if(menu == 1) {
    ...
    if(button_value) {
      ...
      case 3: cureTemp = highResin[0];
              ...
              menu = 5;
              break;
      case 4: cureTemp = resin_0[0];
              cureTime = resin_0[1];
              menu = 5;
              break;
      case 5: cureTemp = resin_1[0];
              cureTime = resin_1[1];
              menu = 5;
              break;
      case 6: cureTemp = resin_2[0];
              cureTime = resin_2[1];
              menu = 5;
              break;
      case 7: cureTemp = resin_3[0];
              cureTime = resin_3[1];
              menu = 5;
              break;
      case 8: cureTemp = resin_4[0];
              cureTime = resin_4[1];
              menu = 5;
              break;
